    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden text-slate-800">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="flex justify-center items-center space-x-3 mb-6">
          ...
          <span className="text-3xl font-extrabold text-slate-900 tracking-tight">SkillBridge</span>
        </div>
        <h2 className="text-center text-xl font-medium text-slate-700">
          Close the college-to-industry gap
        </h2>
        <p className="mt-1 text-center text-sm text-slate-500">
          Structured pipelines, real projects, verified rewards.
        </p>
      </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:bg-white transition-all text-sm"
                  />
                </div>
              </div>
            )}
